...
const Data = () => {
    return (
      <div className="home__data">
         <h1 className="home__title"> Abbas Aslanbay
         <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
         ...
         <h3 className="home__subtitle">Software Technologies</h3>
         <p className="home__description">
            A Seniour Full Stack developer from Turkey, I like coffee coffee and coffee
         </p>
